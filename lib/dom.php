...
function gtranslator($url){
$trans = "http://translate.googleusercontent.com/translate_c?hl=en&sl=en&tl=af&u=".$url."&rurl=translate.google.com&twu=1&usg=ALkJrhhxPIf2COh7LOgXGl4jZdEBNutZAg";
// Create a DOM object
$html = new simple_html_dom();
$str = file_get_contents($trans);
